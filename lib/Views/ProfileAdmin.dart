          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // --- NAMA & ROLE ---
                  Text(nama.isNotEmpty ? nama : 'Admin', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF1A1A2E))),
                  ...
                  Container(
                    ...
                    child: const Text('Administrator', style: TextStyle(color: Color(0xFF4364F7), fontWeight: FontWeight.bold, fontSize: 13)),
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Divider(height: 30, color: Color(0xFFF4F7FE), thickness: 1.5),
                        _infoRow('Nomor Telepon', phone.isNotEmpty ? phone : '-', Icons.phone_outlined),
                      ],
                    ),
                  ),
