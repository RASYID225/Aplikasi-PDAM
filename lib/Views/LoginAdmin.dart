...
class _LoginAdminState extends State<LoginAdmin> {
        ...
        child: Column(
          children: [
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Username',
                          prefixIcon: const Icon(Icons.person_outline, color: Color(0xFF4364F7)),
                          filled: true,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Password',
                          prefixIcon: const Icon(Icons.lock_outline, color: Color(0xFF4364F7)),
                      ...
                      Center(
                        child: TextButton(
                          onPressed: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const RegisterView())),
                          child: RichText(
                            text: const TextSpan(
                              text: 'Belum punya akun? ',
                              style: TextStyle(color: Colors.black54),
                              children: [
                                TextSpan(text: 'Daftar Sekarang', style: TextStyle(color: Color(0xFF4364F7), fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildRoleBtn(context, Icons.person, 'Pelanggan', false),
                const SizedBox(width: 40),
                _buildRoleBtn(context, Icons.admin_panel_settings, 'Admin', true),
              ],
            ),
            const SizedBox(height: 30),
          ],
  ...
  Widget _buildRoleBtn(BuildContext context, IconData icon, String label, bool isActive) {
    Color color = isActive ? const Color(0xFF4364F7) : Colors.grey.shade400;
    return GestureDetector(
      onTap: () {
        if (label == 'Admin') Navigator.pushNamed(context, '/Login');
        else Navigator.pushNamed(context, '/LoginCustomer');
      },
      child: Column(
        children: [
          Container(
